...
description="了解 JitAI 平台架构、应用概念、JAAP 协议、元素体系和开发框架，掌握平台的基础原理。"
...
description="学习如何下载和安装 JitAI 平台，包括桌面版和服务器版的不同部署场景。"
...
description="掌握强大的可视化开发环境，熟悉 IDE 的各个功能区域，学会在可视化和源码双模式之间自由切换。"
...
description="官方云端应用发布服务，提供中心化应用仓库、版本管理和 JitNode 间的无缝部署。"
...
description="基于 JAAP 协议的应用目录结构和元素源码管理，包括应用导出导入功能。"
...
description="AI 加持的 ai-data-management-page，智能辅助高效完成数据浏览、筛选、编辑与批量操作。"
...
description="通过自然语言描述需求，AI 自动生成数据图表，支持用户随时调整图表样式和统计维度。"
...
description="创建文档型页面，支持丰富的 Markdown 语法和文档展示需求。"
...
## 在门户和页面中使用 AI {#using-ai-portals-pages}
...
<IndexCard
title="在组件化页面中使用 AI Agent"
href="devguide/using-ai-in-portals-and-pages/using-ai-assistants-in-component-pages"
description="在组件化页面中集成 AI Agent，并订阅 AI 事件，实现人机协作。"

> <LinkGrid links={[

    { text: "AI Agent 事件订阅", href: "devguide/using-ai-in-portals-and-pages/using-ai-assistants-in-component-pages#ai-agent-event-subscription" },
    { text: "在页面中发送 AI 消息", href: "devguide/using-ai-in-portals-and-pages/using-ai-assistants-in-component-pages#send-ai-message" },
    { text: "直接调用 AI Agent", href: "devguide/using-ai-in-portals-and-pages/using-ai-assistants-in-component-pages#call-ai-agent" }
...
description="从页面直接调用 AI 元素，包括 AI Agent、LLM 服务和知识库，用于动态内容生成。"

> <LinkGrid links={[

    { text: "在页面中使用 AI Agent", href: "devguide/using-ai-in-portals-and-pages/using-ai-elements-in-pages#using-ai-agent-in-pages" },
    { text: "可视化调用", href: "devguide/using-ai-in-portals-and-pages/using-ai-elements-in-pages#visual-calling-agent" },
    { text: "全代码调用", href: "devguide/using-ai-in-portals-and-pages/using-ai-elements-in-pages#full-code-calling-agent" },
...
description="掌握从页面调用数据模型函数的技巧，执行 CRUD 操作、数据查询和数据库交互，实现实时数据显示。"
...
## 页面中的全代码自定义 UI 组件 {#fullcode-ui-components-pages}
...
description="学习创建全代码 UI 组件的接口规范和标准，包括属性、状态管理和生命周期方法。"
...
description="基于 React 开发页面级自定义组件，自主控制界面、逻辑、样式和模型数据操作。"
/>
...
description="配置页面布局和容器组件，包括弹窗、标签页、折叠面板和子页面容器等。"

> <LinkGrid links={[

    { text: "弹窗组件", href: "devguide/using-functional-components-in-pages/layout-components#popup-components" },
    { text: "弹窗组件配置", href: "devguide/using-functional-components-in-pages/layout-components#popup-components-configuration" },
    { text: "弹窗交互设计", href: "devguide/using-functional-components-in-pages/layout-components#popup-components-interaction-design" },
    { text: "标签页组件", href: "devguide/using-functional-components-in-pages/layout-components#tab-components" },
    { text: "标签页组件配置", href: "devguide/using-functional-components-in-pages/layout-components#tab-components-configuration" },
    { text: "标签页交互设计", href: "devguide/using-functional-components-in-pages/layout-components#tab-components-interaction-design" },
    { text: "折叠面板组件", href: "devguide/using-functional-components-in-pages/layout-components#collapse-components" },
    { text: "折叠面板组件配置", href: "devguide/using-functional-components-in-pages/layout-components#collapse-components-configuration" },
    { text: "折叠面板交互设计", href: "devguide/using-functional-components-in-pages/layout-components#collapse-components-interaction-design" },
    { text: "子页面组件", href: "devguide/using-functional-components-in-pages/layout-components#subpage-components" }
...
description="与工作流集成的 UI 组件，用于提交审批申请、处理审批任务和管理审批历史，具有事件驱动通知功能。"
...
description="通过统一接口实现多平台支付处理的功能性 UI 元素，原生支持支付宝和微信支付，提供完整的交易生命周期管理。"
...
description="强大的数据导入和解析工具，支持 Excel 文件批量导入、数据清洗、条件筛选和主子表关联导入。"
...
## AI 大模型 {#ai-large-language-models}
...
<IndexCard
title="为应用接入可复用的 AI 大模型"
href="devguide/ai-llm/create-ai-llm"
description="选择适合 Agent、知识库、业务函数和多模态生成的大模型来源，配置 API Key、备用 Key、可用模型和模型能力。"

> <LinkGrid links={[

    { text: "按 Agent、知识库和多模态场景选择模型来源", href: "devguide/ai-llm/create-ai-llm#mainstream-llm-vendor-support-list" },
    { text: "创建可复用的大模型厂商元素", href: "devguide/ai-llm/create-ai-llm#creating-llm-vendor-elements" },
    { text: "用备用 API Key 提高模型调用稳定性", href: "devguide/ai-llm/create-ai-llm#retry-backup-api-key-mechanism" },
    { text: "管理可被 Agent 和知识库选择的模型能力", href: "devguide/ai-llm/create-ai-llm#custom-model-configuration" },
    { text: "接入本地或私有化 OpenAI 兼容模型", href: "devguide/ai-llm/create-ai-llm#private-llm-integration" },
    ...
    { text: "在业务逻辑中选择合适的大模型函数", href: "devguide/ai-llm/llm-input-output#llm-programming-interface" }

]} />
</IndexCard>

<IndexCard
title="在页面和后端函数中调用大模型"
href="devguide/ai-llm/llm-input-output"
description="配置模型、提示词变量和结构化输出，并按业务需要调用文本生成、向量化、重排和多模态生成函数。"
...
> <LinkGrid links={[
    ...
    { text: "embedQuery", href: "devguide/ai-llm/llm-input-output#embedquery" },
    { text: "rerankDocuments", href: "devguide/ai-llm/llm-input-output#rerankdocuments" },
    { text: "多模态生成函数", href: "devguide/ai-llm/llm-input-output#texttoimage" }

]} />
</IndexCard>

<IndexCard
title="用百炼万相生成图片和视频内容"
href="devguide/ai-llm/implement-multimodal-aigc"
description="在页面和后端函数中调用百炼万相能力，实现文生图、图生图、文生视频、图生视频和首尾帧生视频。"

> <LinkGrid links={[

    { text: "文生图功能", href: "devguide/ai-llm/implement-multimodal-aigc#text-to-image" },
    { text: "文生视频功能", href: "devguide/ai-llm/implement-multimodal-aigc#text-to-video" },
    { text: "图生图功能", href: "devguide/ai-llm/implement-multimodal-aigc#image-to-image" },
    { text: "图生视频功能", href: "devguide/ai-llm/implement-multimodal-aigc#image-to-video" },
    { text: "首尾帧生视频功能", href: "devguide/ai-llm/implement-multimodal-aigc#keyframe-to-video" }
...
<IndexCard
title="创建可被 Agent 检索的 AI 知识库"
href="devguide/knowledge-base/create-knowledge-elements"
description="创建面向 Agent 和业务函数使用的 AI 知识库，选择向量数据库、向量模型和可选重排模型，并了解向量召回与关键词召回如何配合。"

> <LinkGrid columns={2} links={[

    { text: "创建用于产品文档问答的 AI 知识库元素", href: "devguide/knowledge-base/create-knowledge-elements#create-ai-knowledge-base-element" },
    { text: "知识库如何把资料变成可检索内容", href: "devguide/knowledge-base/create-knowledge-elements#principle-description" },
    { text: "文档处理流程", href: "devguide/knowledge-base/create-knowledge-elements#data-processing-flow" },
...
<IndexCard
title="管理知识库资料并验证检索效果"
href="devguide/knowledge-base/knowledge-base-document-management"
description="向 AI 知识库添加本地文档或 Web URL，并通过重排、关键词召回、查询测试等设置优化检索效果。"

> <LinkGrid columns={2} links={[

    { text: "添加本地文档或网页资料", href: "devguide/knowledge-base/knowledge-base-document-management#add-local-documents-or-web-pages" },
    { text: "根据查询效果调整知识库设置", href: "devguide/knowledge-base/knowledge-base-document-management#knowledge-base-settings" },
    { text: "用查询测试检查资料是否命中", href: "devguide/knowledge-base/knowledge-base-document-management#query-testing" },
...
<IndexCard
title="让 Agent 按场景查阅知识库"
href="devguide/knowledge-base/integrate-knowledge-base-into-agent"
description="在 Agent 中启用知识库，并根据任务范围选择智能模式、自定义模式或禁用模式。"

> <LinkGrid links={[

    { text: "知识库与 Agent 的关系", href: "devguide/knowledge-base/integrate-knowledge-base-into-agent#relationship-between-knowledge-base-and-agent" },
    { text: "Agent 使用知识库的运行过程", href: "devguide/knowledge-base/integrate-knowledge-base-into-agent#technical-integration-principles" },
    { text: "根据 Agent 任务范围选择知识库模式", href: "devguide/knowledge-base/integrate-knowledge-base-into-agent#integration-modes" },
    { text: "自定义模式下控制是否预检索", href: "devguide/knowledge-base/integrate-knowledge-base-into-agent#using-knowledge-base-in-agent" },
    { text: "为 DeepAgent 的不同子 Agent 准备不同资料范围", href: "devguide/knowledge-base/integrate-knowledge-base-into-agent#configure-knowledge-base-for-deepagent-subagents" }
...
<IndexCard
title="AI 知识库的 API 开放"
href="devguide/knowledge-base/ai-knowledge-base-api-exposure"
description="通过 API 接口开放 AI 知识库能力，实现与外部系统集成。"
...
### 入门路径：先选型，再做出第一个可用 Agent {#ai-agent-getting-started}

<div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '20px', marginBottom: '40px'}}>

<IndexCard
title="认识 AI Agent"
href="devguide/ai-agent/overview"
description="Agent 可直接调用数据模型函数、服务函数和页面函数，触及应用的各个层次。了解四种 Agent 类型，找到适合你业务场景的方案。"

> <LinkGrid columns={2} links={[

    { text: "Agent 能触及的层次", href: "devguide/ai-agent/overview#agent-能触及的层次" },
    { text: "四种 Agent，覆盖所有场景", href: "devguide/ai-agent/overview#四种-agent覆盖所有场景" },
    { text: "我该选哪种", href: "devguide/ai-agent/overview#我该选哪种" },
    { text: "下一步", href: "devguide/ai-agent/overview#下一步" }

]} />
</IndexCard>

<IndexCard
title="从一个业务任务开始搭建可用 Agent"
href="devguide/ai-agent/build-first-usable-agent"
description="按一条完整主线完成 Agent 创建、模型选择、提示词编写、工具配置、测试验证和上线前检查。"

> <LinkGrid columns={2} links={[

    { text: "先选一个边界清楚的业务任务", href: "devguide/ai-agent/build-first-usable-agent#choose-a-specific-business-task" },
    { text: "创建 ReActAgent 并完成基础配置", href: "devguide/ai-agent/build-first-usable-agent#create-react-agent-and-basic-settings" },
    { text: "只添加完成任务必须使用的工具", href: "devguide/ai-agent/build-first-usable-agent#add-only-required-tools" },
    { text: "在真实任务中测试和收敛", href: "devguide/ai-agent/build-first-usable-agent#verify-with-real-tasks" },
    { text: "上线前补齐安全和体验配置", href: "devguide/ai-agent/build-first-usable-agent#complete-safety-and-experience-before-release" }

]} />
</IndexCard>

<IndexCard
title="最通用的 ReActAgent"
href="devguide/ai-agent/create-react-agent"
description="ReActAgent—最通用的 AI Agent，支持推理与行动交替执行，自主完成任务。"

> <LinkGrid columns={2} links={[

    { text: "创建 Agent", href: "devguide/ai-agent/create-react-agent#创建-agent" },
    { text: "认识编辑器", href: "devguide/ai-agent/create-react-agent#认识编辑器" },
    { text: "选择大模型", href: "devguide/ai-agent/create-react-agent#选择大模型" },
    { text: "编写能力描述", href: "devguide/ai-agent/create-react-agent#编写能力描述" },
    { text: "编写 System Prompts", href: "devguide/ai-agent/create-react-agent#编写-system-prompts" },
    { text: "按需切换源码模式", href: "devguide/ai-agent/create-react-agent#按需切换源码模式" },
    { text: "测试你的 Agent", href: "devguide/ai-agent/create-react-agent#测试你的-agent" }

]} />
</IndexCard>

<IndexCard
title="擅长任务拆解与委派的 DeepAgent"
href="devguide/ai-agent/create-deep-agent"
description="DeepAgent—擅长任务拆解与子Agent委派，多角色协作完成复杂任务。"

> <LinkGrid links={[

    { text: "DeepAgent 适合什么场景", href: "devguide/ai-agent/create-deep-agent#deepagent-适合什么场景" },
    { text: "创建 DeepAgent", href: "devguide/ai-agent/create-deep-agent#创建-deepagent" },
    { text: "选择 DeepAgent 可委派的子 Agent", href: "devguide/ai-agent/create-deep-agent#选择-deepagent-可委派的子-agent" },
    { text: "子 Agent 的能力配置入口", href: "devguide/ai-agent/create-deep-agent#configure-sub-agent-instance" },
    { text: "何时升级到 DeepAgent", href: "devguide/ai-agent/create-deep-agent#何时升级到-deepagent" }

]} />
</IndexCard>

<IndexCard
title="擅长工作流编排的 FlowAgent"
href="devguide/ai-agent/create-flow-agent"
description="FlowAgent—通过可视化工作流编排构建确定性业务流程。"

> <LinkGrid links={[

    { text: "FlowAgent 适合什么场景", href: "devguide/ai-agent/create-flow-agent#flowagent-适合什么场景" },
    { text: "创建和编排工作流", href: "devguide/ai-agent/create-flow-agent#创建和编排工作流" },
    { text: "节点类型一览", href: "devguide/ai-agent/create-flow-agent#节点类型一览" },
    { text: "管理状态数据", href: "devguide/ai-agent/create-flow-agent#管理状态数据" },
    { text: "订阅工作流事件", href: "devguide/ai-agent/create-flow-agent#订阅工作流事件" }

]} />
</IndexCard>

<IndexCard
title="使用 EmbeddedAgent 将 Agent 嵌入外部网页"
href="devguide/ai-agent/create-embedded-agent"
description="EmbeddedAgent—将已有 Agent 实例嵌入第三方网页，支持 JS SDK 和双向交互。"

> <LinkGrid columns={2} links={[

    { text: "EmbeddedAgent 适合什么场景", href: "devguide/ai-agent/create-embedded-agent#embeddedagent-适合什么场景" },
    { text: "创建和配置", href: "devguide/ai-agent/create-embedded-agent#创建和配置" },
    { text: "控制访问安全", href: "devguide/ai-agent/create-embedded-agent#控制访问安全" },
    { text: "嵌入网页", href: "devguide/ai-agent/create-embedded-agent#嵌入网页" },
    { text: "JS SDK 功能", href: "devguide/ai-agent/create-embedded-agent#js-sdk-功能" },
    { text: "双向交互", href: "devguide/ai-agent/create-embedded-agent#双向交互" },
    { text: "完整示例", href: "devguide/ai-agent/create-embedded-agent#完整示例" }
...
### 工具、知识和 Skill：让 Agent 能接入业务系统 {#ai-agent-tools-and-knowledge}

<div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '20px', marginBottom: '40px'}}>

<IndexCard
title="让 Agent 操作数据库"
href="devguide/ai-agent/agent-tool-data-model"
description="将数据模型添加为 Agent 工具，让 AI 能够查询和操作业务数据。"

> <LinkGrid links={[

    { text: "配置数据模型", href: "devguide/ai-agent/agent-tool-data-model#配置数据模型" },
    { text: "内置函数与自定义函数", href: "devguide/ai-agent/agent-tool-data-model#内置函数与自定义函数" },
    { text: "典型场景", href: "devguide/ai-agent/agent-tool-data-model#典型场景" }

]} />
</IndexCard>

<IndexCard
title="让 Agent 调用服务函数"
href="devguide/ai-agent/agent-tool-service-function"
description="将服务函数添加为 Agent 工具，让 AI 执行复杂的业务逻辑。"

> <LinkGrid links={[

    { text: "配置服务函数", href: "devguide/ai-agent/agent-tool-service-function#配置服务函数" },
    { text: "让大模型准确理解你的函数", href: "devguide/ai-agent/agent-tool-service-function#让大模型准确理解你的函数" },
    { text: "典型场景", href: "devguide/ai-agent/agent-tool-service-function#典型场景" }

]} />
</IndexCard>

<IndexCard
title="让 Agent 操作页面组件"
href="devguide/ai-agent/agent-tool-page-function"
description="为 Agent 指定工作页面，让 AI 能够操作前端界面组件。"

> <LinkGrid links={[

    { text: "配置工作页面", href: "devguide/ai-agent/agent-tool-page-function#配置工作页面" },
    { text: "在用户门户中验证", href: "devguide/ai-agent/agent-tool-page-function#在用户门户中验证" },
    { text: "典型场景", href: "devguide/ai-agent/agent-tool-page-function#典型场景" }
...
<IndexCard
title="按需向大模型暴露工具函数"
href="devguide/ai-agent/agent-tool-management"
description="控制哪些工具函数会进入系统提示词，降低 Token 消耗和误选工具的概率。"

> <LinkGrid links={[

    { text: "控制提示词中暴露哪些函数", href: "devguide/ai-agent/agent-tool-management#control-functions-exposed-to-llm" },
    { text: "哪些函数不建议暴露给大模型", href: "devguide/ai-agent/agent-tool-management#functions-that-should-not-be-exposed" }

]} />
</IndexCard>

<IndexCard
title="用输入输出配置让 Agent 可被程序稳定调用"
href="devguide/ai-agent/agent-input-output"
description="定义 Agent 的输入变量和输出格式，让聊天使用和程序调用都能获得稳定结果。"

> <LinkGrid links={[

    { text: "定义输入变量", href: "devguide/ai-agent/agent-input-output#configuring-input-variables" },
    { text: "定义输出格式", href: "devguide/ai-agent/agent-input-output#定义输出格式" },
    { text: "语音识别服务", href: "devguide/ai-agent/agent-input-output#speech-recognition-service" }
...
> <LinkGrid links={[
    ...
    { text: "为主 Agent 配置知识库", href: "devguide/ai-agent/agent-knowledge-base#为主-agent-配置知识库" },
    { text: "配置每个知识库的查询策略", href: "devguide/ai-agent/agent-knowledge-base#配置每个知识库的查询策略" },
    { text: "为 DeepAgent 的子 Agent 配置专属知识库", href: "devguide/ai-agent/agent-knowledge-base#为-deepagent-的子-agent-配置专属知识库" }

]} />
</IndexCard>

<IndexCard
title="为 Agent 开启联网搜索"
href="devguide/ai-agent/agent-web-search"
description="为 Agent 配置公开网页搜索和网页读取能力，适合查询最新资料、公开网页内容和临时外部信息。"

> <LinkGrid links={[

    { text: "先准备联网搜索服务商", href: "devguide/ai-agent/agent-web-search#prepare-web-search-provider" },
    { text: "在 Agent 中启用联网搜索", href: "devguide/ai-agent/agent-web-search#enable-web-search-in-agent" },
    { text: "配置搜索范围和返回内容", href: "devguide/ai-agent/agent-web-search#configure-search-scope-and-content" },
    { text: "和知识库、文件空间如何分工", href: "devguide/ai-agent/agent-web-search#web-search-knowledge-base-file-space" }
...
<IndexCard
title="为 Agent 安装技能"
href="devguide/ai-agent/agent-skill"
description="为 Agent 添加可复用的技能包，快速扩展 Agent 的专业能力。"

> <LinkGrid links={[

    { text: "添加和管理 Skill", href: "devguide/ai-agent/agent-skill#添加和管理-skill" },
    { text: "典型场景", href: "devguide/ai-agent/agent-skill#典型场景" }
...
### 上下文、记忆和安全：让 Agent 更稳定地长期运行 {#ai-agent-context-memory-security}

<div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '20px', marginBottom: '40px'}}>

<IndexCard
title="让 Agent 拥有记忆"
href="devguide/ai-agent/agent-memory"
description="配置 Agent 的会话状态存储和跨会话长期记忆，包括向量检索、记忆写入和时间衰减。"

> <LinkGrid links={[

    { text: "会话状态存储", href: "devguide/ai-agent/agent-memory#会话状态存储" },
    { text: "跨会话长期记忆", href: "devguide/ai-agent/agent-memory#跨会话长期记忆" },
    { text: "检索方式", href: "devguide/ai-agent/agent-memory#检索方式" },
    { text: "典型场景", href: "devguide/ai-agent/agent-memory#典型场景" }
...
<IndexCard
title="Agent 文件空间"
href="devguide/ai-agent/agent-file-space"
description="三种文件空间的配置方法、路径规则、上传/读写路由行为，以及 System Prompts 编写建议。"

> <LinkGrid columns={2} links={[

    { text: "Agent 空间", href: "devguide/ai-agent/agent-file-space#agent-空间" },
    { text: "个人空间", href: "devguide/ai-agent/agent-file-space#个人空间" },
    { text: "组织空间", href: "devguide/ai-agent/agent-file-space#组织空间" },
    { text: "路径规则", href: "devguide/ai-agent/agent-file-space#路径规则" },
    { text: "文件路由规则", href: "devguide/ai-agent/agent-file-space#文件路由规则" },
    { text: "运行时效果", href: "devguide/ai-agent/agent-file-space#运行时效果" },
    { text: "典型场景", href: "devguide/ai-agent/agent-file-space#典型场景" }
...
<IndexCard
title="自定义 LLM 调用参数"
href="devguide/ai-agent/agent-llm-params"
description="自定义 Agent 的大模型调用参数，包括温度、最大 Token 数、推理努力程度等，按需微调模型行为。"

> <LinkGrid links={[

    { text: "通用参数", href: "devguide/ai-agent/agent-llm-params#通用参数" },
    { text: "推理模型参数", href: "devguide/ai-agent/agent-llm-params#推理模型参数" },
    { text: "自定义模型的 JSON 配置", href: "devguide/ai-agent/agent-llm-params#自定义模型的-json-配置" },
    { text: "视觉模型参数", href: "devguide/ai-agent/agent-llm-params#视觉模型参数" }
...
<IndexCard
title="运行时上下文注入"
href="devguide/ai-agent/agent-runtime-context"
description="配置运行时上下文注入，让 Agent 感知当前时间、用户身份和语言偏好。"

> <LinkGrid links={[

    { text: "始终注入的信息", href: "devguide/ai-agent/agent-runtime-context#始终注入的信息" },
    { text: "角色与组织信息", href: "devguide/ai-agent/agent-runtime-context#角色与组织信息" }
...
<IndexCard
title="自动压缩对话上下文"
href="devguide/ai-agent/agent-context"
description="自动压缩对话历史，通过摘要降低大模型的上下文压力。"

> <LinkGrid links={[

    { text: "工作机制", href: "devguide/ai-agent/agent-context#工作机制" },
    { text: "配置项", href: "devguide/ai-agent/agent-context#配置项" },
    { text: "子Agent 配置", href: "devguide/ai-agent/agent-context#子agent-配置" },
    { text: "典型场景", href: "devguide/ai-agent/agent-context#典型场景" }
...
<IndexCard
title="隐私保护"
href="devguide/ai-agent/agent-privacy"
description="配置 PII 检测和脱敏规则，保护对话中的敏感信息。"

> <LinkGrid columns={2} links={[

    { text: "启用配置", href: "devguide/ai-agent/agent-privacy#启用配置" },
    { text: "处理范围", href: "devguide/ai-agent/agent-privacy#处理范围" },
    { text: "内置识别规则", href: "devguide/ai-agent/agent-privacy#内置识别规则" },
    { text: "脱敏策略", href: "devguide/ai-agent/agent-privacy#脱敏策略" },
    { text: "自定义规则", href: "devguide/ai-agent/agent-privacy#自定义规则" },
    { text: "典型场景", href: "devguide/ai-agent/agent-privacy#典型场景" }
...
<IndexCard
title="控制 Agent 访问权限"
href="devguide/ai-agent/agent-permissions"
description="通过平台统一的 RBAC 权限体系，控制 Agent 的可见范围、数据访问和服务函数调用权限。"

> <LinkGrid links={[

    { text: "控制 Agent 的可见范围", href: "devguide/ai-agent/agent-permissions#控制-agent-的可见范围" },
    { text: "控制数据模型的访问范围", href: "devguide/ai-agent/agent-permissions#控制数据模型的访问范围" },
    { text: "控制服务函数的调用范围", href: "devguide/ai-agent/agent-permissions#控制服务函数的调用范围" },
    { text: "配置入口", href: "devguide/ai-agent/agent-permissions#配置入口" }
...
### 运行入口、程序调用和高级扩展 {#ai-agent-runtime-and-integration}

<div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '20px', marginBottom: '40px'}}>

<IndexCard
title="使用钩子函数实现运行时拦截扩展"
href="devguide/ai-agent/agent-runtime-extension"
description="通过 Python 代码在生命周期关键节点插入自定义逻辑。"

> <LinkGrid links={[

    { text: "配置运行扩展", href: "devguide/ai-agent/agent-runtime-extension#配置运行扩展" },
    { text: "代码结构", href: "devguide/ai-agent/agent-runtime-extension#代码结构" },
    { text: "可用的生命周期钩子", href: "devguide/ai-agent/agent-runtime-extension#可用的生命周期钩子" },
    { text: "典型场景", href: "devguide/ai-agent/agent-runtime-extension#典型场景" }

]} />
</IndexCard>

<IndexCard
title="从建模到分析看懂内置 Agent"
href="devguide/ai-agent/agent-built-in"
description="按任务选择内置 Agent，并理解它们如何组合 DeepAgent、Skill、文件空间、权限、隐私保护和 AI 开发助手等平台能力。"

> <LinkGrid links={[

    { text: "按任务选 Agent", href: "devguide/ai-agent/agent-built-in#choose-built-in-agent-by-task" },
    { text: "业务需求建模", href: "devguide/ai-agent/agent-built-in#business-requirement-modeling" },
    { text: "数据库结构建模", href: "devguide/ai-agent/agent-built-in#database-structure-modeling" },
    { text: "AI 开发助手", href: "devguide/ai-agent/agent-built-in#ai-development-assistant" },
    { text: "业务数据洞察", href: "devguide/ai-agent/agent-built-in#business-data-insight" },
    { text: "平台能力范式", href: "devguide/ai-agent/agent-built-in#platform-capabilities-used-by-built-in-agents" }

]} />
</IndexCard>

<IndexCard
title="使用 AI 开发助手开发 JitAI 元素"
href="devguide/ai-agent/ai-development-assistant"
description="在 IDE 中用自然语言创建、修改和修复 JitAI 元素，并通过差异预览、应用变更、构建和刷新完成开发闭环。"

> <LinkGrid links={[

    { text: "它和普通 AI 助手有什么不同", href: "devguide/ai-agent/ai-development-assistant#difference-from-common-ai" },
    { text: "首次使用前配置开发模型", href: "devguide/ai-agent/ai-development-assistant#configure-developer-model" },
    { text: "开发助手能开发哪些元素", href: "devguide/ai-agent/ai-development-assistant#supported-elements" },
    { text: "推荐的协作流程", href: "devguide/ai-agent/ai-development-assistant#recommended-workflow" },
    { text: "差异预览和变更应用", href: "devguide/ai-agent/ai-development-assistant#diff-review-and-apply" }

]} />
</IndexCard>

<IndexCard
title="在聊天页面中使用 Agent"
href="devguide/ai-agent/agent-chat-page"
description="了解如何通过 URL 访问 Agent 聊天页面，直接进入指定 Agent 或选择 Agent 开始对话。"

> <LinkGrid links={[

    { text: "访问聊天页面", href: "devguide/ai-agent/agent-chat-page#访问聊天页面" },
    { text: "直接进入指定 Agent", href: "devguide/ai-agent/agent-chat-page#直接进入指定-agent" },
    { text: "选择 Agent 开启对话", href: "devguide/ai-agent/agent-chat-page#选择-agent-开启对话" },
    { text: "管理会话", href: "devguide/ai-agent/agent-chat-page#管理会话" },
    { text: "对话交互", href: "devguide/ai-agent/agent-chat-page#对话交互" }

]} />
</IndexCard>

<IndexCard
title="在前后端程序中调用 Agent"
href="devguide/ai-agent/agent-integration"
description="将 Agent 集成到应用中，支持前端页面调用、后端服务调用和代码级 API。"

> <LinkGrid links={[

    { text: "在前端页面中调用", href: "devguide/ai-agent/agent-integration#在前端页面中调用" },
    { text: "在后端服务中调用", href: "devguide/ai-agent/agent-integration#在后端服务中调用" },
    { text: "实时查看运行过程", href: "devguide/ai-agent/agent-integration#实时查看运行过程" }
...
<IndexCard
title="配置欢迎语和预置问题"
href="devguide/ai-agent/agent-welcome"
description="配置 Agent 的欢迎语和预置问题，降低用户首次使用的门槛。"

> <LinkGrid links={[

    { text: "欢迎语", href: "devguide/ai-agent/agent-welcome#欢迎语" },
    { text: "预置问题", href: "devguide/ai-agent/agent-welcome#预置问题" },
    { text: "典型配置示例", href: "devguide/ai-agent/agent-welcome#典型配置示例" }
...
description="理解 Skill 的定位：把业务流程、输出规范、判断规则和示例模板沉淀为可复用能力，供多个 Agent 安装使用。"

> <LinkGrid links={[

    { text: "什么场景适合沉淀为 Skill", href: "devguide/skills/overview#what-should-be-a-skill" },
    { text: "Skill、Agent、知识库、工具各负责什么", href: "devguide/skills/overview#skill-agent-knowledge-tool" },
    { text: "多个 Agent 复用同一套能力", href: "devguide/skills/overview#reuse-skill-across-agents" },
    { text: "从一个高频任务开始设计 Skill", href: "devguide/skills/overview#start-from-repeatable-task" }
...
description="在 IDE 的 Skills 入口创建标准 Skill，用名称和描述说明能力边界，并进入编辑器维护 Skill 内容。"

> <LinkGrid links={[

    { text: "从 IDE 的 Skills 入口创建", href: "devguide/skills/create-skill#create-from-skills-entry" },
    { text: "用名称说明 Skill 的复用能力", href: "devguide/skills/create-skill#name-the-reusable-capability" },
    { text: "用描述限定适用场景和边界", href: "devguide/skills/create-skill#describe-scope-and-boundary" },
    { text: "创建后安装到 Agent 使用", href: "devguide/skills/create-skill#install-skill-after-create" }

]} />
</IndexCard>

<IndexCard
title="设计稳定可复用的 Skill"
href="devguide/skills/skill-best-practices"
description="学习如何设计边界清晰、流程稳定、输出可检查、便于长期维护的高质量 Skill。"

> <LinkGrid links={[

    { text: "从一个可复用任务开始", href: "devguide/skills/skill-best-practices#start-from-repeatable-task" },
    { text: "用能力范围限定边界", href: "devguide/skills/skill-best-practices#define-capability-scope" },
    { text: "用执行步骤沉淀流程", href: "devguide/skills/skill-best-practices#write-execution-steps" },
    { text: "用输出格式稳定结果", href: "devguide/skills/skill-best-practices#stabilize-output-format" },
    { text: "先验证再复用", href: "devguide/skills/skill-best-practices#validate-before-reuse" }
...
description="把复杂规则、术语表、输出模板和示例拆成附件，让 Skill 主提示词保持清晰。"

> <LinkGrid links={[

    { text: "什么内容适合放进附件", href: "devguide/skills/skill-attachments#what-belongs-in-attachments" },
    { text: "业务规则如何拆成附件", href: "devguide/skills/skill-attachments#split-business-rules" },
    { text: "术语表和模板如何维护", href: "devguide/skills/skill-attachments#maintain-glossary-and-templates" },
    { text: "主提示词和附件如何分工", href: "devguide/skills/skill-attachments#main-content-vs-attachments" }

]} />
</IndexCard>

<IndexCard
title="为 Agent 安装 Skill"
href="devguide/skills/use-skill-in-agent"
description="把创建好的 Skill 安装到 Agent 中，根据任务范围选择智能模式、自定义模式或禁用模式。"

> <LinkGrid links={[

    { text: "Agent 为什么需要 Skill", href: "devguide/skills/use-skill-in-agent#why-agent-needs-skills" },
    { text: "在 Agent 编辑器中进入 Skills 配置", href: "devguide/skills/use-skill-in-agent#open-skills-tab-in-agent" },
    { text: "智能模式适合多场景 Agent", href: "devguide/skills/use-skill-in-agent#smart-mode" },
    { text: "自定义模式适合能力边界明确的 Agent", href: "devguide/skills/use-skill-in-agent#custom-mode" },
    { text: "AI Agent 中安装 Skill", href: "devguide/ai-agent/agent-skill#添加和管理-skill" }
...
description="以数据查询场景为例，学习如何围绕数据模型设计问数 Skill、组织查询模板和字段说明。"

> <LinkGrid links={[

    { text: "一个 Skill 专注一个数据场景", href: "devguide/skills/query-skill-best-practices#one-skill-one-data-scenario" },
    { text: "问数需求的普适分类", href: "devguide/skills/query-skill-best-practices#query-requirement-types" },
    { text: "用内置 Agent 生成和验证查询模板", href: "devguide/skills/query-skill-best-practices#generate-and-verify-query-templates" },
    { text: "核心文件体系", href: "devguide/skills/query-skill-best-practices#query-skill-files" },
    { text: "通用检查清单", href: "devguide/skills/query-skill-best-practices#query-skill-checklist" }
...
<IndexCard
title="让 Agent 有地方保存、读取和交付文件"
href="devguide/ai-file-storage/overview"
description="理解 AI 文件空间的定位，区分 Agent 空间、个人空间和组织空间，并判断什么时候需要先创建文件空间。"

> <LinkGrid links={[

    { text: "三类文件空间分别解决什么问题", href: "devguide/ai-file-storage/overview#three-types-of-file-spaces" },
    { text: "文件空间、知识库和 Skill 如何分工", href: "devguide/ai-file-storage/overview#file-space-knowledge-base-skill" },
    { text: "什么时候应该先创建文件空间", href: "devguide/ai-file-storage/overview#when-to-create-file-space" },
    { text: "推荐的创建顺序", href: "devguide/ai-file-storage/overview#recommended-setup-order" }

]} />
</IndexCard>

<IndexCard
title="为 Agent 准备专属工作空间"
href="devguide/ai-file-storage/create-agent-space"
description="创建 Agent 空间，用于保存某个 Agent 的工作文件、临时结果和生成内容，并按需要开启用户隔离。"

> <LinkGrid links={[

    { text: "从 AI 文件空间入口创建 Agent 空间", href: "devguide/ai-file-storage/create-agent-space#create-agent-space" },
    { text: "文件空间名称决定 Agent 使用的路径前缀", href: "devguide/ai-file-storage/create-agent-space#space-name-as-path-prefix" },
    { text: "是否开启按用户隔离", href: "devguide/ai-file-storage/create-agent-space#isolate-agent-space-by-user" },
    { text: "清理策略适合临时文件和工作文件", href: "devguide/ai-file-storage/create-agent-space#cleanup-policy-for-working-files" }
...
<IndexCard
title="为每个用户准备私有文件空间"
href="devguide/ai-file-storage/create-user-space"
description="创建个人空间，让每个用户拥有跨 Agent、跨会话可复用的私有文件区域。"

> <LinkGrid links={[

    { text: "从 AI 文件空间入口创建个人空间", href: "devguide/ai-file-storage/create-user-space#create-user-space" },
    { text: "个人空间适合保存什么", href: "devguide/ai-file-storage/create-user-space#what-belongs-in-user-space" },
    { text: "用户上传文件如何进入个人空间", href: "devguide/ai-file-storage/create-user-space#uploaded-files-go-to-user-space" },
    { text: "清理策略要根据业务保留周期设置", href: "devguide/ai-file-storage/create-user-space#cleanup-policy-for-user-files" }
...
<IndexCard
title="用组织空间维护团队共享资料"
href="devguide/ai-file-storage/create-org-space"
description="创建组织空间保存团队共享文件，默认只读，并按需为指定 Agent 开启写入权限。"

> <LinkGrid links={[

    { text: "从 AI 文件空间入口创建组织空间", href: "devguide/ai-file-storage/create-org-space#create-org-space" },
    { text: "组织空间适合保存什么", href: "devguide/ai-file-storage/create-org-space#what-belongs-in-org-space" },
    { text: "组织空间默认只读", href: "devguide/ai-file-storage/create-org-space#org-space-is-readonly-by-default" },
    { text: "组织空间不自动清理", href: "devguide/ai-file-storage/create-org-space#org-space-no-auto-cleanup" }
...
<IndexCard
title="管理组织空间中的共享文件"
href="devguide/ai-file-storage/manage-org-files"
description="在管理区门户中使用组织文件空间管理页面上传、查看、删除和整理团队共享资料，需要用户拥有管理门户权限。"

> <LinkGrid links={[

    { text: "进入组织文件空间管理页面", href: "devguide/ai-file-storage/manage-org-files#open-org-file-space-management" },
    { text: "上传团队共享资料", href: "devguide/ai-file-storage/manage-org-files#upload-shared-files" },
    { text: "查看和整理文件", href: "devguide/ai-file-storage/manage-org-files#browse-and-organize-files" },
    { text: "让 Agent 使用组织资料", href: "devguide/ai-file-storage/manage-org-files#let-agent-use-org-files" }

]} />
</IndexCard>

<IndexCard
title="在 Agent 中配置可访问的文件空间"
href="devguide/ai-file-storage/use-file-space-in-agent"
description="在 Agent 中选择可访问的 Agent 空间、个人空间和组织空间，并通过提示词约定文件路径。"

> <LinkGrid links={[

    { text: "选择 Agent 空间保存工作文件", href: "devguide/ai-file-storage/use-file-space-in-agent#select-agent-space" },
    { text: "选择个人空间处理用户上传文件", href: "devguide/ai-file-storage/use-file-space-in-agent#select-user-space" },
    { text: "选择组织空间读取团队资料", href: "devguide/ai-file-storage/use-file-space-in-agent#select-org-space" },
    { text: "用真实文件任务验证配置", href: "devguide/ai-file-storage/use-file-space-in-agent#verify-with-real-file-tasks" }

]} />
</IndexCard>

<IndexCard
title="规划稳定的文件路径、隔离和清理规则"
href="devguide/ai-file-storage/path-cleanup-rules"
description="理解文件空间名称、逻辑路径、根目录、隔离规则和清理策略，避免 Agent 读写到错误位置。"

> <LinkGrid links={[

    { text: "文件空间名称就是路径前缀", href: "devguide/ai-file-storage/path-cleanup-rules#space-name-is-path-prefix" },
    { text: "根目录不是 Agent 使用的路径", href: "devguide/ai-file-storage/path-cleanup-rules#root-dir-is-not-agent-path" },
    { text: "三类空间的隔离规则不同", href: "devguide/ai-file-storage/path-cleanup-rules#isolation-rules" },
    { text: "上线前检查清单", href: "devguide/ai-file-storage/path-cleanup-rules#release-checklist" }
...
<IndexCard
title="把现场语音变成 Agent 能处理的业务指令"
href="devguide/speech-recognition/overview"
description="理解 AI 语音识别在 Agent 链路中的位置，判断哪些移动端、现场作业和客服场景适合开启语音输入。"

> <LinkGrid links={[

    { text: "语音识别在 Agent 链路中的位置", href: "devguide/speech-recognition/overview#speech-recognition-in-agent-flow" },
    { text: "什么场景适合开启语音输入", href: "devguide/speech-recognition/overview#when-to-enable-voice-input" },
    { text: "语音识别、输入变量和输出格式如何配合", href: "devguide/speech-recognition/overview#voice-input-output-config" },
    { text: "推荐配置顺序", href: "devguide/speech-recognition/overview#recommended-setup-order" }

]} />
</IndexCard>

<IndexCard
title="创建一个供 Agent 使用的语音识别服务"
href="devguide/speech-recognition/create-speech-recognition"
description="在 IDE 中创建硅基流动语音识别服务，配置 API Key 和默认识别模型，并用名称说明服务边界。"

> <LinkGrid links={[

    { text: "从 AI 语音识别入口创建服务", href: "devguide/speech-recognition/create-speech-recognition#create-from-speech-recognition-entry" },
    { text: "配置 API Key", href: "devguide/speech-recognition/create-speech-recognition#configure-api-key" },
    { text: "选择默认识别模型", href: "devguide/speech-recognition/create-speech-recognition#choose-default-model" },
    { text: "保存后在 Agent 中选择使用", href: "devguide/speech-recognition/create-speech-recognition#select-service-in-agent" }

]} />
</IndexCard>

<IndexCard
title="为 Agent 开启语音输入能力"
href="devguide/speech-recognition/use-speech-recognition-in-agent"
description="在 Agent 的输入输出配置中选择语音识别服务，让聊天入口支持录音、转写和语音输入。"

> <LinkGrid links={[

    { text: "在输入输出配置中选择语音识别服务", href: "devguide/speech-recognition/use-speech-recognition-in-agent#select-service-in-input-output" },
    { text: "语音转写结果如何进入 Agent", href: "devguide/speech-recognition/use-speech-recognition-in-agent#how-transcription-enters-agent" },
    { text: "语音输入与输入变量一起使用", href: "devguide/speech-recognition/use-speech-recognition-in-agent#use-with-input-variables" },
    { text: "在聊天入口验证语音输入", href: "devguide/speech-recognition/use-speech-recognition-in-agent#verify-in-chat-entry" }

]} />
</IndexCard>

<IndexCard
title="设计真实业务场景中的语音输入体验"
href="devguide/speech-recognition/voice-input-scenarios"
description="围绕移动端咨询、现场作业、客服坐席和会议访谈，设计更稳定的语音输入体验和上线检查清单。"

> <LinkGrid links={[

    { text: "移动端咨询", href: "devguide/speech-recognition/voice-input-scenarios#mobile-consultation" },
    { text: "现场作业", href: "devguide/speech-recognition/voice-input-scenarios#field-work" },
    { text: "客服坐席", href: "devguide/speech-recognition/voice-input-scenarios#customer-service" },
    { text: "语音输入上线前检查清单", href: "devguide/speech-recognition/voice-input-scenarios#release-checklist" }
...
description="JitAI 应用的数据基础层，学习如何创建和配置数据表，设计字段类型和约束。"
...
description="专为全代码开发环境设计的专业数据结构，类似于 DTO，用于业务逻辑中的结构化数据表达和传递。"
...
<IndexCard
title="在 AI Agent 中调用数据模型"
href="devguide/data-modeling/calling-data-models-in-ai-agent"
description="将数据模型函数添加为 Agent 工具，使 AI 能够智能地执行数据的创建、读取、更新、删除等操作。"
...
description="了解 JitAI 支持的各种数据库类型和连接配置。"
...
description="用户身份验证和登录方式配置，支持多种认证模式，包括第三方 OAuth 和企业集成。"
...
> <LinkGrid links={[
    ...
    { text: "用角色先限定可使用的 Agent", href: "devguide/user-and-permission/roles-and-business-element-permissions#grant-agent-access-by-role" },
    { text: "限制角色在页面和 Agent 中可执行的数据模型函数", href: "devguide/user-and-permission/roles-and-business-element-permissions#portal-level-data-operation-type-and-scope-control" },
    { text: "用数据筛选和字段权限收窄可访问数据范围", href: "devguide/user-and-permission/roles-and-business-element-permissions#limit-data-scope-and-field-visibility" },
    { text: "只向必要角色开放高风险服务函数", href: "devguide/user-and-permission/roles-and-business-element-permissions#grant-service-function-permissions" },
    { text: "让角色权限和工具暴露各司其职", href: "devguide/user-and-permission/roles-and-business-element-permissions#coordinate-agent-data-service-permissions" }

]} />
</IndexCard>

<IndexCard
title="Agent 工具暴露与角色权限边界"
href="devguide/user-and-permission/agent-tool-permission-control"
description="说明 Agent 工具暴露不是权限控制，真正的访问控制由角色权限和运行时检查承担。"

> <LinkGrid links={[

    { text: "先用角色权限控制谁能使用 Agent", href: "devguide/user-and-permission/agent-tool-permission-control#control-who-can-use-agent" },
    { text: "再用数据模型和服务函数权限约束 Agent 能做什么", href: "devguide/user-and-permission/agent-tool-permission-control#control-what-agent-can-do" },
    { text: "按需暴露工具函数，减少误调用", href: "devguide/user-and-permission/agent-tool-permission-control#configure-agent-tool-execution-permissions" },
    { text: "上线前用真实角色验证 Agent 权限", href: "devguide/user-and-permission/agent-tool-permission-control#verify-agent-permissions-before-release" }
...
description="将 JitAI 应用添加到企业工作台，并配置免登和移动端访问体验。"

> <LinkGrid links={[

    { text: "企业微信工作台应用指南", href: "devguide/user-and-permission/wechat-work-app-guide" },
    { text: "钉钉工作台应用指南", href: "devguide/user-and-permission/dingtalk-workspace-app-guide" },
    { text: "飞书工作台应用指南", href: "devguide/user-and-permission/feishu-workspace-app-guide" }
...
description="后端业务逻辑实现，通过服务元素封装可复用的业务函数，提供 API 接口和数据处理服务。"
...
description="学习如何在服务函数中调用其他元素，包括模型、其他服务、外部 API 和系统组件，实现全面的业务逻辑实现。"
...
<IndexCard
title="创建通用的外部 API 元素"
href="devguide/third-party-integration/external-api"
description="无缝集成第三方 HTTP 接口，提供统一的 RESTful API 调用管理，支持标准 HTTP 方法和高级处理功能。"
...
## 内部 API 开放 {#internal-api-exposure}
...
description="API 接口的权限控制和访问授权管理。"
...
<IndexCard
title="各类元素的 API 暴露示例"
href="devguide/api-exposure/api-exposure-examples-for-various-elements"
description="全面展示如何将不同类型的元素暴露为 API 的示例，包括数据模型、服务和自定义函数。"
...
<IndexCard
title="使用 SDK 调用被授权元素的 API"
href="devguide/api-exposure/using-sdk-to-call-authorized-element-apis"
description="学习如何使用官方 SDK 调用被授权的元素 API，包括身份验证、请求处理和错误管理。"
...
## 前端 UI 定制 {#frontend-ui-customization}
...
description="开发个性化 UI 组件，满足特殊业务需求和交互要求。"
...
> <LinkGrid links={[
    ...
    { text: "前端调试指南", href: "devguide/advanced-guide/frontend-debugging-guide" }
...
description="使用 AI Agent 和高级提示词工程技术构建智能应用，实现增强用户体验和自动化工作流程。"
...
description="基于 JitORM 构建销售数据分析系统，实现多维度聚合分析和业务规则自动化。"

> <LinkGrid links={[

    { text: "业务实体建模与数据分析", href: "devguide/advanced-guide/business-entity-modeling-and-data-analysis" },
    { text: "模型性能优化", href: "devguide/advanced-guide/model-performance-optimization" }
...
description="基于 JitService 实现自定义鉴权和业务服务架构。"
