...
> <LinkGrid links={[
    ...
    { text: "打开 AI 开发助手", href: "devguide/ai-agent/ai-development-assistant#open-ai-development-assistant" },
    { text: "首次使用前配置开发模型", href: "devguide/ai-agent/ai-development-assistant#configure-developer-model" },
    { text: "开发助手能做什么", href: "devguide/ai-agent/ai-development-assistant#capabilities" },
