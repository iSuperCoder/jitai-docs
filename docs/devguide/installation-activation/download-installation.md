...
3. Complete the activation process as prompted. See [Developer Team Management](./developer-team-management) for detailed instructions.
...
4. Open your browser and navigate to `http://{server-IP-address}:80`, then complete the activation process. See [Developer Team Management](./developer-team-management) for detailed instructions.
